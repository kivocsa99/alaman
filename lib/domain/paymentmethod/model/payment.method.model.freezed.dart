...
class _$PaymentMethodModelImpl extends _PaymentMethodModel {
  ...
  @override
  String toString() {
    return 'PaymentMethodModel(id: $id, name: $name, name_ar: $name_ar, created_at: $created_at, updated_at: $updated_at, deleted_at: $deleted_at)';
  }
...
abstract class _PaymentMethodModel extends PaymentMethodModel {
  const factory _PaymentMethodModel(
      ...
      final String? created_at,
      final String? updated_at,
      final String? deleted_at}) = _$PaymentMethodModelImpl;
