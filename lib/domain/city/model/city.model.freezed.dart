...
class _$CityModelImpl extends _CityModel {
  ...
  @override
  String toString() {
    return 'CityModel(id: $id, name: $name, name_ar: $name_ar, created_at: $created_at, updated_at: $updated_at, deleted_at: $deleted_at)';
  }
...
abstract class _CityModel extends CityModel {
  const factory _CityModel(
      ...
      final String? created_at,
      final String? updated_at,
      final String? deleted_at}) = _$CityModelImpl;
