...
import 'package:alaman/presentation/screens/reset_password_screen.dart';
...
class AppRouter extends _$AppRouter {
  ...
  List<AutoRoute> get routes => [
        AutoRoute(initial: false, page: OnBoardingRoute.page, guards: [AuthGuard()]),
        AutoRoute(
          initial: true,
